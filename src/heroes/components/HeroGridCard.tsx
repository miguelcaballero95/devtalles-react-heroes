    ...
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
      <div className="relative h-64">
        <img
          ...
          alt={hero.alias}
          onClick={handleClick}
          className="object-cover transition-all duration-500 group-hover:scale-110 absolute -top-7.5 w-full h-100"
        />
        ...
        {/* Universe badge */}
        <Badge className={`absolute top-3 right-3 text-xs ${hero.universe === 'DC' ? 'bg-blue-600' : 'bg-red-600'} text-white`}>
          {hero.universe}
        </Badge>

        {/* Favorite button */}
        <Button onClick={() => toggleFavorite(hero)} size="sm" variant="ghost" className="absolute bottom-3 right-3 bg-white/90 hover:bg-white">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <Progress value={hero.strength * 10} className="h-2 [&>div]:bg-orange-500" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={hero.intelligence * 10} className="h-2 [&>div]:bg-blue-500" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={hero.speed * 10} className="h-2 [&>div]:bg-green-500" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={hero.durability * 10} className="h-2 [&>div]:bg-purple-500" />
          </div>
        </div>
